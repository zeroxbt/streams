...
export class IdentifyService {
    ...
    async identify(connection) {
        ...
        const [data] = await pipe([], stream, lp.decode(), (source) => take(source, 1), async (source) => await all(source));
        if (data == null) {
    ...
    async _handleIdentify(data) {
        ...
        try {
            ...
            await pipe([message], lp.encode(), stream, drain);
        }
        catch (err) {
    ...
    async _handlePush(data) {
        ...
        let message;
        try {
            const data = await pipe([], stream, lp.decode(), async (source) => await first(source));
            if (data != null) {
                message = Identify.decode(data);
            }
        }
